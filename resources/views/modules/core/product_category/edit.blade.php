    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <form class="form-horizontal form-label-left" action="{{route('product-category.update',$productCategory->id)}}" method="POST" autocomplete="off">
                ...
                {{csrf_field()}}
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input class="form-control input-sm" value="{{$productCategory->name}}" type="text" name="name">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>Short Name</label>
                                <input class="form-control input-sm" type="text" value="{{$productCategory->short_name}}" name="short_name">
                            </div>
                        </div>
