            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" ng-app="myApp">
                    <div class="x_title">
                        ...
                        <a href="{{route('proforma-invoice.index')}}" class="btn btn-sm btn-primary btn-addon pull-right"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Foreign Proforma Invoice List</a>
                        <div class="clearfix"></div>
                    </div>
