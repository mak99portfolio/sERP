            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a href="{{ route('delivery-schedule.create') }}" class="btn btn-sm btn-primary btn-addon pull-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New Schedule</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
