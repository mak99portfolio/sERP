        ...
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a href="{{ route('sales-invoice-cancel.index')}}" class="btn btn-sm btn-primary btn-addon pull-right"><i class="fa fa-list-ul" aria-hidden="true"></i> Invoice Cancel List</a>
