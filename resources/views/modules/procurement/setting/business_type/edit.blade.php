            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="{{route('business-type.update',$businessType)}}" method="POST" autocomplete="off">
                        <input name="_method" type="hidden" value="PUT"> 
                        {{ csrf_field() }}
                     <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 item">
                            {{ BootForm::text('name','Title', $businessType->name, ['class'=>'form-control input-sm', 'required']) }}
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 item">
                            {{ BootForm::text('short_name','Short Title', $businessType->short_name, ['class'=>'form-control input-sm']) }}
                            </div>
