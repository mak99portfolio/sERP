                        ...
                        <form class="form-horizontal">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-4 col-xs-12">Requisition Title</label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-5 col-xs-12">Reference No</label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-5 col-xs-12">Requisition Type</label>
                                    <div class="col-md-9 col-sm-7 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-5 col-xs-12">Requisition Purpose</label>
                                    <div class="col-md-9 col-sm-7 col-xs-12">
                                        <select class="form-control input-sm">
                                            <option value="">Choose..</option>
                                            <option value="press">Press</option>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-5 col-xs-12">Requisition Priority</label>
                                    <div class="col-md-9 col-sm-7 col-xs-12">
                                        <select class="form-control input-sm">
                                            <option value="">Choose..</option>
                                            <option value="press">Press</option>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-5 col-xs-12">Department</label>
                                    <div class="col-md-9 col-sm-7 col-xs-12">
                                        <select class="form-control input-sm">
                                            <option value="">Choose..</option>
                                            <option value="press">Press</option>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default bg-light">
                                    <div class="panel-heading" style="padding: 5px 17px;">
                                        <!-- <button class="btn m-b-xs btn-sm btn-default btn-addon"><i class="fa fa-plus"></i></button> -->
                                        <label>Search <a href="#"><strong>Product</strong></a></label>
                                        <button class="btn m-b-xs btn-sm btn-default btn-addon pull-right" data-toggle="modal"
