            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" ng-app="myApp">
                    <div class="x_title">
                        ...
                        <a href="{{route('cnf.index')}}" class="btn btn-sm btn-primary btn-addon pull-right"><i class="fa fa-list-ul" aria-hidden="true"></i> Duty TAX, VAT and CNF Bill List</a>
                        <div class="clearfix"></div>
                    </div>
                            ...
                            <div class="row">
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                          <button class="btn btn-primary btn-sm" type="button" ng-click="addParticular()">Add</button>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{route('cnf.index')}}" class="btn btn-default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
