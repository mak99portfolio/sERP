        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a class="btn btn-primary btn-sm pull-right" href="{{route('product-category.create')}}"><i class="fa fa-plus-circle"></i> Add new</a>
                    <div class="clearfix"></div>
                </div>
                        ...
                        <table class="table table-bordered datatable-buttons">
                            ...
                            @foreach ($product_category as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{ route('product-category.edit',$item) }}" type="button" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i>Edit</a></td>
