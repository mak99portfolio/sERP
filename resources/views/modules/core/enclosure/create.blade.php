            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="{{route('enclosure.store')}}" method="POST" autocomplete="off">
                            {{csrf_field()}}
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ BootForm::text('name','Enclosure Name', null, ['class'=>'form-control input-sm']) }}
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
