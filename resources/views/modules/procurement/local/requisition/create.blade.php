        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" ng-app="myApp">
                    <div class="x_title">
                        <h2>Requisition</h2>
                        <a href="{{route('local-requisition.index')}}" class="btn btn-sm btn-primary btn-addon pull-right"><i class="fa fa-list-ul" aria-hidden="true"></i> See Requisition Lists</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content" ng-controller="myCtrl">
                        <br />
                        <form class="form-horizontal form-label-left" action="{{route('local-requisition.store')}}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row">
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height: 75vh; overflow-y: auto">
                        <table class="table table-bordered m-t-lg table-hover" id="datatable-checkbox">
                            <thead class="bg-default">
                                <tr>
                                    <th>#</th>
                                    <th></th>
