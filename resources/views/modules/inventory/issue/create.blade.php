                    ...
                    <div class="x_content">
						...
						{{ BootForm::open(['model'=>$issue, /*'store'=>'issue.store',*/ 'update'=>'issue.update']) }}
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {{ BootForm::select('inventory_item_status_id', 'Item Status', $inventory_item_statuses, null, ['class'=>'form-control input-sm', 'disabled'=>'true']) }}
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {{ BootForm::select('inventory_item_pattern_id', 'Item Pattern', $inventory_item_patterns, null, ['class'=>'form-control input-sm', 'disabled'=>'true']) }}
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
