            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a class="btn btn-primary btn-sm pull-right" href="{{route('modes-of-transport.index')}}"><i class="fa fa-list"></i> Modes Of Transport List</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        ...
                        <form class="form-horizontal form-label-left" action="{{route('modes-of-transport.store')}}" method="POST" autocomplete="off">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-default" href="{{route('modes-of-transport.index')}}">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
